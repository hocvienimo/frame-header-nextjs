...
import BtnContact from '@/components/ButtonContact';
    ...
    <section className="py-16 overflow-hidden">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            <LabelButtonTag text='Tại sao chọn chúng tôi' icon={FaClipboardUser}/>
            <h1>
                {aboutContent.heading.title}
            </h1>
            <p className='text-accent font-extrabold uppercase mb-5 md:text-lg text-sm'>{aboutContent.heading.subtitle}</p>
            ...
            <motion.div
              ...
              viewport={{ once:false, amount: 0.2 }}
            >
                <BtnContact text='Hãy liên hệ iMovn' containerStyles='items-center'/>
            </motion.div>
