        ...
        >
            <section className="py-16 bg-cover bg-center">
                <div className="container mx-auto md:flex block gap-10 items-center">
                    ...
                    >
                        <h2 className="pb-3 text-3xl font-bold">Sự Khác Biệt Của iMovn</h2>
                            ...
                            {difference.map((item, index) => (
                                <div key={index} className="mb-6">
                                    <div className="flex items-center mb-2">
                                        <item.icon className="text-2xl text-accent mr-2"/>
                                        <h4 className="text-2xl text-secondary font-semibold">{item.title}</h4>
                                    </div>
                                    <p className="md:ml-10">{item.text}</p>
                                </div>
                            ))}
                        </div>
                    </motion.div>
                            ...
                            {stats.map((item, index) => (
                                ...
                                >
                                    <div ref={ref} className="border border-accent/90 md:w-[140px] w-[110px] md:h-[140px] h-[110px] mx-auto rounded-full p-2 mb-3">
                                        <div className="border border-accent/30 w-full h-full flex flex-col items-center justify-center text-primary md:text-4xl text-2xl font-extrabold rounded-full bg-white">
                                            {isInView && (
